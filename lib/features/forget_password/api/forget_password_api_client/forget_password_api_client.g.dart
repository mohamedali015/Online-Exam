...
class _ForgetPasswordApiClient implements ForgetPasswordApiClient {
  ...
  @override
  Future<EnterEmailResponse> enterEmail(EnterEmailRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<EnterEmailResponse>(
    ...
    late EnterEmailResponse _value;
    try {
      _value = EnterEmailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<NewPasswordResponse> getNewPassword(NewPasswordRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
